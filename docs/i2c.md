...
## I2C на MegaD-328
У MegaD-328 нет аппаратного I2C, поэтому режим I2C-ANY и сканирование шины на нём недоступны.
Для него интеграция реализует программный I2C по http (аналог библиотеки I2C-PHP):
поддерживаются SCD41, HTU21D, OPT3001, MAX44009 и комбинированный MegaD-Outdoor-Sensor.
[Подробнее про raw_i2c](yaml.md#raw_i2c).
